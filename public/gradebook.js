function fetchGradeData() {
    ...
    // When the request changest status, we run this anonymous function
...
function populateGradebook(data) {
    ...
    let tableElm = document.getElementById("gradebook", data); // Get the gradebook table element
        data.forEach(function(assignment){ // For each row of date we're passed in
